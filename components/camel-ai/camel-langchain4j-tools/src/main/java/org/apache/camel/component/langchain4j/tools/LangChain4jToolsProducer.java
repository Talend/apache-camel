...
//            System.out.println("Finished iteration " + i);
    ...
    private boolean isDoneExecuting(Response<AiMessage> response) {
        if (!response.content().hasToolExecutionRequests()) {
            System.out.println("Finished executing tools because of there are no more execution requests");
            return true;
        }

        if (response.finishReason() != null) {
            System.out.println("Finished executing tools because of " + response.finishReason());
    ...
    private void invokeTools(
        ...
        for (ToolExecutionRequest toolExecutionRequest : toolExecutionRequests) {
            ...
            System.out.println("Invoking tool " + i + " (" + toolName + ") of " + toolExecutionRequests.size());
