...
public class JsonSchemaProperty {
     ...
     * @deprecated       please use the new {@link JsonSchemaElement} API instead to define the schema for tool
     *                   parameters
     */
    @Deprecated(forRemoval = true)
    ...
    private boolean equalTo(JsonSchemaProperty another) {
        if (!Objects.equals(key, another.key))
            return false;
     ...
     *
     * <p>
     * Equivalent to {@code new JsonSchemaProperty(key, value)}.
     *
     * @param      key   the key.
     * @param      value the value.
     ...
     *
     * <p>
     * Equivalent to {@code new JsonSchemaProperty("type", value)}.
     *
     * @param      value the value.
     * @return           a property with key and value.
     * @deprecated       please use the new {@link JsonSchemaElement} API instead to define the schema for tool
     ...
     *
     * <p>
     * Equivalent to {@code new JsonSchemaProperty("description", value)}.
     *
     * @param      value the value.
     * @return           a property with key and value.
     * @deprecated       please use the new {@link JsonSchemaElement} API instead to define the schema for tool
     ...
     *
     * @param      enumValues enum values. For example:
     *                        {@code enums(TemperatureUnit.CELSIUS, TemperatureUnit.FAHRENHEIT)}
     * @return                a property with key "enum" and value enumValues
     * @deprecated            please use {@link JsonEnumSchema} instead
     */
    @Deprecated(forRemoval = true)
