...
public interface SmbEndpointBuilderFactory {
    ...
    public interface AdvancedSmbEndpointBuilder
         ...
         * @return the dsl builder
         */
        default AdvancedSmbEndpointBuilder idempotentRepository(org.apache.camel.spi.IdempotentRepository idempotentRepository) {
            doSetProperty("idempotentRepository", idempotentRepository);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedSmbEndpointBuilder idempotentRepository(String idempotentRepository) {
            doSetProperty("idempotentRepository", idempotentRepository);
            return this;
        }
        /**
         ...
         * @return the dsl builder
         */
        default AdvancedSmbEndpointBuilder smbIoBean(org.apache.camel.component.smb.SmbIOBean smbIoBean) {
            doSetProperty("smbIoBean", smbIoBean);
            return this;
        }
        /**
