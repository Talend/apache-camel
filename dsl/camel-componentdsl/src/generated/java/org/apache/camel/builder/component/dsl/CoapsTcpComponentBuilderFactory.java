...
public interface CoapsTcpComponentBuilderFactory {
     ...
     */
    interface CoapsTcpComponentBuilder extends ComponentBuilder<CoAPComponent> {
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class CoapsTcpComponentBuilderImpl
            ...
            implements CoapsTcpComponentBuilder {
        @Override
