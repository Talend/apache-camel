...
public interface Sjms2ComponentBuilderFactory {
    ...
    interface Sjms2ComponentBuilder extends ComponentBuilder<Sjms2Component> {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder connectionFactory(jakarta.jms.ConnectionFactory connectionFactory) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder destinationCreationStrategy(org.apache.camel.component.sjms.jms.DestinationCreationStrategy destinationCreationStrategy) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder exceptionListener(jakarta.jms.ExceptionListener exceptionListener) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder jmsKeyFormatStrategy(org.apache.camel.component.sjms.jms.JmsKeyFormatStrategy jmsKeyFormatStrategy) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder messageCreatedStrategy(org.apache.camel.component.sjms.jms.MessageCreatedStrategy messageCreatedStrategy) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder replyToOnTimeoutMaxConcurrentConsumers(int replyToOnTimeoutMaxConcurrentConsumers) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder requestTimeoutCheckerInterval(long requestTimeoutCheckerInterval) {
         ...
         * @return the dsl builder
         */
        default Sjms2ComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
    ...
    class Sjms2ComponentBuilderImpl
            extends AbstractComponentBuilder<Sjms2Component>
            implements Sjms2ComponentBuilder {
        @Override
