...
public interface Activemq6ComponentBuilderFactory {
    ...
    interface Activemq6ComponentBuilder extends ComponentBuilder<ActiveMQComponent> {
         ...
         * @return the dsl builder
         */
        default Activemq6ComponentBuilder objectMessageEnabled(boolean objectMessageEnabled) {
         ...
         * @return the dsl builder
         */
        default Activemq6ComponentBuilder deserializationFilter(java.lang.String deserializationFilter) {
