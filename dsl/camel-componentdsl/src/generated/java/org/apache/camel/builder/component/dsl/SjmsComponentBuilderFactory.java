...
public interface SjmsComponentBuilderFactory {
    ...
    interface SjmsComponentBuilder extends ComponentBuilder<SjmsComponent> {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder connectionFactory(jakarta.jms.ConnectionFactory connectionFactory) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder destinationCreationStrategy(org.apache.camel.component.sjms.jms.DestinationCreationStrategy destinationCreationStrategy) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder exceptionListener(jakarta.jms.ExceptionListener exceptionListener) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder jmsKeyFormatStrategy(org.apache.camel.component.sjms.jms.JmsKeyFormatStrategy jmsKeyFormatStrategy) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder messageCreatedStrategy(org.apache.camel.component.sjms.jms.MessageCreatedStrategy messageCreatedStrategy) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder replyToOnTimeoutMaxConcurrentConsumers(int replyToOnTimeoutMaxConcurrentConsumers) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder requestTimeoutCheckerInterval(long requestTimeoutCheckerInterval) {
         ...
         * @return the dsl builder
         */
        default SjmsComponentBuilder headerFilterStrategy(org.apache.camel.spi.HeaderFilterStrategy headerFilterStrategy) {
    ...
    class SjmsComponentBuilderImpl
            extends AbstractComponentBuilder<SjmsComponent>
            implements SjmsComponentBuilder {
        @Override
