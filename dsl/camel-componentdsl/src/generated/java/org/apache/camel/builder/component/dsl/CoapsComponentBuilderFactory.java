...
public interface CoapsComponentBuilderFactory {
    ...
    interface CoapsComponentBuilder extends ComponentBuilder<CoAPComponent> {
         ...
         * @return the dsl builder
         */
        default CoapsComponentBuilder bridgeErrorHandler(boolean bridgeErrorHandler) {
         ...
         * @return the dsl builder
         */
        default CoapsComponentBuilder lazyStartProducer(boolean lazyStartProducer) {
    ...
    class CoapsComponentBuilderImpl
            ...
            implements CoapsComponentBuilder {
        @Override
