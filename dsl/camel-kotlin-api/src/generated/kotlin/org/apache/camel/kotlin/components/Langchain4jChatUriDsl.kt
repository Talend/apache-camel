 ...
 */
public fun UriDsl.`langchain4j-chat`(i: Langchain4jChatUriDsl.() -> Unit) {
  Langchain4jChatUriDsl(this).apply(i)
}

@CamelDslMarker
public class Langchain4jChatUriDsl(
  it: UriDsl,
) {
  ...
  init {
    this.it = it
    this.it.component("langchain4j-chat")
  }
