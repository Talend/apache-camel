...
:page-source: componentscamel-cxfsrcmaindocscxf-component.adoc
:docTitle: CXF
...
|===
| Name | Description | Default | Type
| *dataFormat* (common) | The data type messages supported by the CXF endpoint. There are 5 enums and the value can be one of: PAYLOAD, RAW, MESSAGE, CXF_MESSAGE, POJO | POJO | DataFormat
